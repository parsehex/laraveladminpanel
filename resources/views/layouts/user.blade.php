...
<body class="bg-gray-100">
    <div x-data="{ sidebarOpen: false }" x-effect="document.body.classList.toggle('overflow-hidden', sidebarOpen); if (sidebarOpen) { $nextTick(() => window.scrollSidebarToActiveLink?.()) }" class="flex h-screen flex-col overflow-hidden">
